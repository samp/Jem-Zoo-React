    ...
    return (
        <div>
            ...
            <main>
                ...
                <Cards2>
                    <Card title="Tickets" content={"<p>Adult: £" + props.zoodata.adult + "</p><p>Child (2-16): £" + props.zoodata.child + "</p><p>Concession: £" + props.zoodata.concession + "</p><p>Under 2s go free</p><p>Save up to 20% by booking ahead!</p>"} image="images/ticket-square-fallback.jpg" link="/tickets" linkText="Buy Tickets" />
